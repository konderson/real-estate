...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("Phone Number"),
                                    max_length=30, default="+455667777")
    about_me = models.TextField(verbose_name=_("About me"),
                                default="say something about yourself")
    license = models.CharField(verbose_name=_("Real Estate licence"),
    ...
    coutry = CountryField(verbose_name=_("Country"), default="KE",
                          blank="False", null=False)
    city = models.CharField(verbose_name=_("City"), max_length=180,
                            default="Nairobi", blank=False, null=False)

    is_bayer = models.BooleanField(verbose_name=_("Bayer"), default=False,
                                   help_text=_("Are you looking to Buy a Propery?"))
    is_seller = models.BooleanField(verbose_name=_("Seller"), default=False,
                                    help_text=_("Are you looking to Sell a Propery?"))
    ...
    num_reviews = models.IntegerField(verbose_name=_("Number of Review"),
